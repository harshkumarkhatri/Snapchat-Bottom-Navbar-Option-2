...
import 'package:snapchat_bottom_navbar_option_2/Widgets/ChatWidgets/bottomBarChat_Widget.dart';
import 'package:snapchat_bottom_navbar_option_2/Widgets/ChatWidgets/chatMessage_Widget.dart';
import 'package:snapchat_bottom_navbar_option_2/Widgets/ChatWidgets/date_Widget.dart';
import 'friendDetails_Screen.dart';

class Chat extends StatefulWidget {
  Chat(this.cameras, this.name);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          bottomBarChat1(context, widget.cameras),
        ],
      ),
    );
  }
